...
undocu_model <- glm(undocu_likely ~ age + education + married + english_difficult + spanish_hispanic_latino + medicaid + household_size + race + employed + citizen + years_us, data = sipp08_2, family = binomial)
...
confusionMatrix(pred_classes, test_data$undocu_likely)
