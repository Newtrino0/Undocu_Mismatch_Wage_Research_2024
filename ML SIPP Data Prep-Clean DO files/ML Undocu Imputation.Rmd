...
key_predictors <- c("age", "married", "nonfluent", "spanish_hispanic_latino", "central_latino", "bpl_asia", "asian", "black", "white","other_race", "household_size", "poverty", "employed", "years_us", "yrsed")
...
edu_ctrl <- trainControl(
  ...
  verboseIter = TRUE,
  stratify = TRUE   # Ensure stratified sampling across folds
)
