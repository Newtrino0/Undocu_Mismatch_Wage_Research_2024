...
write.csv(sipp08_2_dTable, "SIPP_rf.csv", row.names = FALSE)
```
...
library(stargazer)
mydata %>%
  select(undocu_likely, bpl_foreign) %>%
  stargazer(type = "text", title="Descriptive statistics", digits=1, out="table4.txt", 
            covariate.labels=c("undocu_likely","% FR Meals","# Enrolled Students",
                               "% Lt HS","% HS grad","% Some College",
