...
sipp08_2_dTable <- sipp08_2[sipp08_2$undocu_logical == 1, c("undocu_likely", "undocu_logical", "bpl_foreign", "medicaid", "central_latino", "bpl_asia", "age", "fem", "married", "nonfluent", "spanish_hispanic_latino", "household_size", "poverty", "asian", "black", "white", "other_race", "employed", "years_us","yrsed")]
sipp08_2_logistic <- sipp08_2[sipp08_2$undocu_logical == 1, c("undocu_likely", "central_latino", "bpl_asia","medicaid", "age", "fem", "married", "nonfluent", "spanish_hispanic_latino", "household_size", "poverty", "asian", "black", "white", "other_race", "employed", "years_us","yrsed")]
sipp08_2_knn <- sipp08_2[sipp08_2$undocu_logical == 1, c("undocu_likely", "central_latino", "bpl_asia", "medicaid", "age", "fem", "married", "nonfluent", "spanish_hispanic_latino", "household_size", "poverty", "asian", "black", "white", "other_race", "employed", "years_us","yrsed")]
sipp08_2_rf <- sipp08_2[sipp08_2$undocu_logical == 1, c("undocu_likely", "central_latino", "bpl_asia", "medicaid", "age", "fem", "married", "nonfluent", "spanish_hispanic_latino", "household_size", "poverty", "asian", "black", "white", "other_race", "employed", "years_us","yrsed")]
sipp08_2_education <- sipp08_2[sipp08_2$undocu_logical == 1 & sipp08_2$college==1, c("undocu_likely", "medicaid", "central_latino", "bpl_asia", "age", "fem", "married", "nonfluent", "spanish_hispanic_latino", "household_size", "poverty", "asian", "black", "white", "other_race", "employed", "years_us")]
...
logistic_kmodel <- train(undocu_likely ~ age + fem + married + nonfluent + spanish_hispanic_latino + central_latino + bpl_asia + medicaid + household_size + poverty + asian + black + white + other_race + employed + years_us + yrsed, train_klogistic,
               method = "glm",
               trControl = control,
               metric = 'ROC')
...
set.seed(1)
rf_model <- train(undocu_likely ~ age + fem + married + medicaid + nonfluent + spanish_hispanic_latino + central_latino + bpl_asia + household_size + poverty + asian + black + white + other_race + employed + years_us + yrsed,
               data = train_rf,
               method = "ranger",
...
set.seed(1)
education_model <- train(undocu_likely ~ age + fem + married + medicaid + nonfluent + spanish_hispanic_latino + central_latino + bpl_asia + household_size + poverty + asian + black + white + other_race + employed + years_us,
               data = train_edu,
               method = "ranger",
               trControl = control_rf,
               tuneLength = 5,
...
library(vip)
library(gridExtra)
feature_importance <- vip(education_model, num_features = 18, bar = FALSE)
...
ACS_sipp_na <- ACS_sipp  %>%
  filter(undocu==1, !is.na(years_us),!is.na(medicaid), !is.na(age),!is.na(fem), !is.na(married), !is.na(nonfluent),  !is.na(spanish_hispanic_latino), !is.na(central_latino), !is.na(bpl_asia), !is.na(household_size), !is.na(poverty), !is.na(asian), !is.na(black), !is.na(white), !is.na(other_race), !is.na(employed),  !is.na(yrsed))

ACS_cols_numeric <- c("central_latino", "bpl_asia", "medicaid", "age", "fem", "married", "nonfluent", "spanish_hispanic_latino", "household_size", "poverty", "asian", "black", "white", "other_race", "employed", "years_us","yrsed")
...
ACS_sipp_na$rf_undocu <- predict(education_model, ACS_sipp_na)
setwd("C:/Users/mario/Documents/Undocu_Mismatch_Wage_Research_2024 Data")
