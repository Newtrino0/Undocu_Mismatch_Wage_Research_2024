...
reg hmismatched vmismatched bpl_foreign inclusive exclusive  $covars metropolitan i.statefip##i.year  [pweight=perwt], r cl(statefip)
estadd ysumm
eststo
***Horizontal undermatch model***
reg hundermatched vmismatched bpl_foreign inclusive exclusive  $covars metropolitan  i.statefip##i.year  [pweight=perwt], r cl(statefip)
estadd ysumm
eststo
***Horizontal overmatch model***
reg hovermatched vmismatched bpl_foreign inclusive exclusive  $covars metropolitan i.statefip##i.year  [pweight=perwt], r cl(statefip)
estadd ysumm
eststo


 cd "C:\Users\mario\Documents\GitHub\Undocu_Mismatch_Wage_Research_2024\Undocu Research Figures ML"
esttab using mismatch_regressions_total.tex, replace label booktabs keep(vmismatched hundermatched hovermatched bpl_foreign inclusive exclusive) ///
order(vmismatched hundermatched hovermatched bpl_foreign inclusive exclusive) ///
...
reg vmismatched hundermatched hovermatched undocu_logit inclusive exclusive  $covars metropolitan i.statefip##i.year  [pweight=perwt], r cl(statefip)
estadd ysumm
eststo
***KNN V. mismatch model***
reg vmismatched hundermatched hovermatched undocu_knn inclusive exclusive  $covars metropolitan i.statefip##i.year  [pweight=perwt], r cl(statefip)
estadd ysumm
eststo

***RF V. mismatch model***
reg vmismatched hundermatched hovermatched undocu_rf inclusive exclusive  $covars metropolitan i.statefip##i.year  [pweight=perwt], r cl(statefip)
estadd ysumm
eststo

cd "C:\Users\mario\Documents\GitHub\Undocu_Mismatch_Wage_Research_2024\Undocu Research Figures ML"
esttab using vmismatch_regressions_ml.tex, replace label booktabs keep(hundermatched hovermatched undocu undocu_logit undocu_knn undocu_rf inclusive exclusive) ///
order(hundermatched hovermatched undocu undocu_logit undocu_knn undocu_rf inclusive exclusive) ///
stats( ymean r2 N  , labels(  "Mean of Dep. Var." "R-squared" N ) fmt(    %9.2f %9.2f %9.0fc ) ) ///
...
reg hmismatched vmismatched undocu_logit inclusive exclusive  $covars metropolitan i.statefip##i.year  [pweight=perwt], r cl(statefip)
estadd ysumm
eststo
***KNN H. mismatch model***
reg hmismatched vmismatched undocu_knn inclusive exclusive  $covars metropolitan i.statefip##i.year  [pweight=perwt], r cl(statefip)
estadd ysumm
eststo
***RF H. mismatch model***
reg hmismatched vmismatched undocu_rf inclusive exclusive  $covars metropolitan i.statefip##i.year  [pweight=perwt], r cl(statefip)
estadd ysumm
eststo

cd "C:\Users\mario\Documents\GitHub\Undocu_Mismatch_Wage_Research_2024\Undocu Research Figures ML"
esttab using hmismatch_regressions_ml.tex, replace label booktabs keep(vmismatched undocu undocu_logit undocu_knn undocu_rf inclusive exclusive) ///
order(vmismatched undocu undocu_logit undocu_knn undocu_rf inclusive exclusive) ///
stats( ymean r2 N  , labels(  "Mean of Dep. Var." "R-squared" N ) fmt(    %9.2f %9.2f %9.0fc ) ) ///
...
reg hundermatched vmismatched undocu_logit inclusive exclusive  $covars metropolitan i.statefip##i.year  [pweight=perwt], r cl(statefip)
estadd ysumm
eststo
***KNN H. undermatch model***
reg hundermatched vmismatched undocu_knn inclusive exclusive  $covars metropolitan i.statefip##i.year  [pweight=perwt], r cl(statefip)
estadd ysumm
eststo
***RF H. undermatch model***
reg hundermatched vmismatched undocu_rf inclusive exclusive  $covars metropolitan i.statefip##i.year  [pweight=perwt], r cl(statefip)
estadd ysumm
eststo

cd "C:\Users\mario\Documents\GitHub\Undocu_Mismatch_Wage_Research_2024\Undocu Research Figures ML"
esttab using hundermatch_regressions_ml.tex, replace label booktabs keep(vmismatched undocu undocu_logit undocu_knn undocu_rf inclusive exclusive ) ///
order(vmismatched undocu undocu_logit undocu_knn undocu_rf inclusive exclusive) ///
stats( ymean r2 N  , labels(  "Mean of Dep. Var." "R-squared" N ) fmt(    %9.2f %9.2f %9.0fc ) ) ///
...
reg ln_adj vmismatched hundermatched hovermatched undocu_logit inclusive exclusive  $covars metropolitan  i.statefip##i.year [pweight=perwt], r cl(statefip)
estadd ysumm
eststo
**KNN column***
reg ln_adj vmismatched hundermatched hovermatched undocu_knn inclusive exclusive  $covars metropolitan  i.statefip##i.year [pweight=perwt], r cl(statefip)
estadd ysumm
eststo
**RF column***
reg ln_adj vmismatched hundermatched hovermatched undocu_rf inclusive exclusive  $covars metropolitan  i.statefip##i.year [pweight=perwt], r cl(statefip)
estadd ysumm
eststo


cd "C:\Users\mario\Documents\GitHub\Undocu_Mismatch_Wage_Research_2024\Undocu Research Figures ML"
esttab using wage_regressions_ml.tex, replace label booktabs keep(vmismatched hundermatched hovermatched undocu undocu_logit undocu_knn undocu_rf inclusive exclusive ) ///
order(vmismatched hundermatched hovermatched undocu undocu_logit undocu_knn undocu_rf inclusive exclusive ) ///
stats( ymean r2 N  , labels(  "Mean of Dep. Var." "R-squared" N ) fmt(    %9.2f %9.2f %9.0fc ) ) ///
