...
xtset statefip
global covars i.age hisp male gov_worker bpl_foreign immig_by_ten nonfluent yrsed stem_deg
...
reg vmismatched hundermatched hovermatched elig elig_post 	inclusive	exclusive	 $covars metropolitan i.statefip##i.year [pweight=perwt], r cl(statefip)
estadd ysumm
eststo
***Horizontal mismatch model***
reg hmismatched vmismatched elig elig_post 	inclusive	exclusive	 $covars metropolitan i.statefip##i.year [pweight=perwt], r cl(statefip)
estadd ysumm
eststo
***Horizontal undermatch model***
reg hundermatched vmismatched elig elig_post 	inclusive	exclusive	 $covars metropolitan i.statefip##i.year  /* */ [pweight=perwt], r cl(statefip)
estadd ysumm
eststo
***Horizontal overmatch model***
reg hovermatched vmismatched elig elig_post 	inclusive	exclusive	 $covars metropolitan i.statefip##i.year  /* */ [pweight=perwt], r cl(statefip)
estadd ysumm
eststo


cd "C:\Users\mario\Documents\GitHub\Undocu_Mismatch_Wage_Research_2024\Undocu Research Figures"
esttab using mismatch_regressions_total.tex, replace label booktabs keep(vmismatched hundermatched hovermatched elig elig_post 	inclusive	exclusive	) ///
order(vmismatched hundermatched hovermatched elig elig_post 	inclusive	exclusive	) ///
...
cd "C:\Users\mario\Documents\GitHub\Undocu_Mismatch_Wage_Research_2024\Undocu Research Figures"
esttab using vmismatch_regressions_ipc.tex, replace label booktabs keep(vmismatched hundermatched hovermatched elig elig_post 	inclusive	exclusive	) ///
order(vmismatched hundermatched hovermatched elig elig_post 	inclusive	exclusive	) ///
stats( ymean r2 N  , labels(  "Mean of Dep. Var." "R-squared" N ) fmt(    %9.2f %9.2f %9.0fc ) ) ///
...
cd "C:\Users\mario\Documents\GitHub\Undocu_Mismatch_Wage_Research_2024\Undocu Research Figures"
esttab using hmismatch_regressions_ipc.tex, replace label booktabs keep(vmismatched hundermatched hovermatched elig elig_post 	inclusive	exclusive	) ///
order(vmismatched hundermatched hovermatched elig elig_post 	inclusive	exclusive	 ) ///
stats( ymean r2 N  , labels(  "Mean of Dep. Var." "R-squared" N ) fmt(    %9.2f %9.2f %9.0fc ) ) ///
...
cd "C:\Users\mario\Documents\GitHub\Undocu_Mismatch_Wage_Research_2024\Undocu Research Figures"
esttab using hundermatch_regressions_ipc.tex, replace label booktabs keep(vmismatched hundermatched hovermatched elig elig_post 	inclusive	exclusive	) ///
order(vmismatched hundermatched hovermatched elig elig_post 	inclusive	exclusive	) ///
stats( ymean r2 N  , labels(  "Mean of Dep. Var." "R-squared" N ) fmt(    %9.2f %9.2f %9.0fc ) ) ///
...
**Complete V. mismatch model**
keep if twentytwo_by_2012==1
reg vmismatched hundermatched hovermatched elig elig_post b1.drivers_license b1.professional_licensure b1.e_verify $covars metropolitan i.statefip##i.year  /* */ [pweight=perwt], r cl(statefip)
estadd ysumm
eststo
***Top 10 states V. mismatch model***
***Greatest number of DACA recipients column***
...
**Complete H. mismatch model**
keep if twentytwo_by_2012==1
reg hmismatched vmismatched elig elig_post b1.drivers_license b1.professional_licensure b1.e_verify $covars metropolitan i.statefip##i.year  /* */ [pweight=perwt], r cl(statefip)
estadd ysumm
eststo
***Top 10 states H. mismatch model***
***Greatest number of DACA recipients column***
...
**Complete H. undermatch model**
keep if twentytwo_by_2012==1
reg hundermatched vmismatched elig elig_post b1.drivers_license b1.professional_licensure b1.e_verify $covars metropolitan i.statefip##i.year  /* */ [pweight=perwt], r cl(statefip)
estadd ysumm
eststo
***Top 10 states H. undermatch model***
***Greatest number of DACA recipients column***
...
***COMPLETE WAGE MODEL***
reg ln_adj vmismatched hundermatched hovermatched elig elig_year* $covars metropolitan i.statefip##i.year b1.annual_total_dummy [pweight=perwt], r cl(statefip)
estadd ysumm
eststo
***Vertical mismatch-elig_year model***
reg vmismatched hundermatched hovermatched elig elig_year* $covars metropolitan i.statefip##i.year  /* */ b1.annual_total_dummy [pweight=perwt], r cl(statefip)
estadd ysumm
eststo 
***Horizontal mismatch-elig_year model***
reg hmismatched vmismatched elig elig_year* $covars metropolitan i.statefip##i.year  /* */ b1.annual_total_dummy [pweight=perwt], r cl(statefip)
estadd ysumm
eststo
***Horizontal undermatch-elig_year model***
reg hundermatched vmismatched elig elig_year* $covars metropolitan i.statefip##i.year  /* */ b1.annual_total_dummy [pweight=perwt], r cl(statefip)
estadd ysumm
eststo
