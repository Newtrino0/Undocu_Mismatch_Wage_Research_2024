...
## Model summary and optimal number of trees
college_gbm_model
print(college_gbm_model$bestTune)
optimal_trees_college <- college_gbm_model$bestTune$n.trees
...
# Add random baseline
total_undocu <- sum(test_gbm_num$undocu_likely == "X1")
