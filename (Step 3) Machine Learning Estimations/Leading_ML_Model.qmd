...
quartile_thresholds_caret <- quantile(top_75_sample$p, probs = c(0, 0.25, 0.5, 0.75, 1))
print(quartile_thresholds_caret)

quartile_thresholds_gbm <- quantile(top_75_sample_num$p, probs = c(0, 0.25, 0.5, 0.75, 1))
