...
variable_lists <- list(
  ...
  descriptive = c("undocu_likely", "undocu_logical", "bpl_foreign", "medicaid", "central_latino", "bpl_asia", "age", "fem", "married", "cit_spouse", "nonfluent", "spanish_hispanic_latino", "household_size", "top_ten_states", "poverty", "asian", "black", "white", "other_race", "employed", "years_us", "yrsed", "college")
