...
replace occS ="Marketing and sales managers"== "50"
replace occS ="Administrative services managers"== "100"
replace occS ="Gaming managers"== "330"
replace occS ="Managers, all other"== "430"
replace occS ="Business operations specialists, all other"== "740"
replace occS ="Financial analysts"== "840"
replace occS ="Financial specialists, all other"== "950"
replace occS ="Software developers, applications and systems software"== "1020"
replace occS ="Web developers"== "1030"
replace occS ="Database administrators"== "1060"
replace occS ="Computer occupations, all other"== "1107"
replace occS ="Architects, except naval"== "1300"
replace occS ="Drafters"== "1540"
replace occS ="Engineering technicians, except drafters"== "1550"
replace occS ="Environmental scientists and geoscientists"== "1740"
replace occS ="Psychologists"== "1820"
replace occS ="Geological and petroleum technicians"== "1930"
replace occS ="Miscellaneous life, physical, and social science technicians"== "1965"
replace occS ="Counselors"== "2000"
replace occS ="Social workers"== "2010"
replace occS ="Miscellaneous legal support workers"== "2160"
replace occS ="Postsecondary teachers"== "2200"
replace occS ="Other teachers and instructors"== "2340"
replace occS ="Librarians"== "2430"
replace occS ="Teacher assistants"== "2540"
replace occS ="Other education, training, and library workers"== "2550"
replace occS ="Designers"== "2630"
replace occS ="Athletes, coaches, umpires, and related workers"== "2720"
replace occS ="Musicians, singers, and related workers"== "2750"
replace occS ="Entertainers and performers, sports and related workers, all other"== "2760"
replace occS ="Announcers"== "2800"
replace occS ="Miscellaneous media and communication workers"== "2860"
replace occS ="Broadcast and sound engineering technicians and radio operators"== "2900"
replace occS ="Media and communication equipment workers, all other"== "2960"
replace occS ="Physicians and surgeons"== "3060"
replace occS ="Health diagnosing and treating practitioners, all other"== "3260"
replace occS ="Diagnostic related technologists and technicians"== "3320"
replace occS ="Emergency medical technicians and paramedics"== "3400"
replace occS ="Health practitioner support technologists and technicians"== "3420"
replace occS ="Medical records and health information technicians"== "3510"
replace occS ="Miscellaneous health technologists and technicians"== "3535"
replace occS ="Other healthcare practitioners and technical occupations"== "3540"
replace occS ="Nursing, psychiatric, and home health aides"== "3600"
replace occS ="First-line supervisors of protective service workers, all other"== "3730"
replace occS ="Bailiffs, correctional officers, and jailers"== "3800"
replace occS ="Police and sheriff's patrol officers"== "3850"
replace occS ="Transit and railroad police"== "3860"
replace occS ="Lifeguards and other recreational, and all other protective service workers"== "3955"
replace occS ="Combined food preparation and serving workers, including fast food"== "4050"
replace occS ="Counter attendants, cafeteria, food concession, and coffee shop"== "4060"
replace occS ="Grounds maintenance workers"== "4250"
replace occS ="First-line supervisors of gaming workers"== "4300"
replace occS ="First-line supervisors of personal service workers"== "4320"
replace occS ="Motion picture projectionists"== "4410"
replace occS ="Miscellaneous entertainment attendants and related workers"== "4430"
replace occS ="Embalmers and funeral attendants"== "4460"
replace occS ="Miscellaneous personal appearance workers"== "4520"
replace occS ="Personal care aides"== "4610"
replace occS ="Recreation and fitness workers"== "4620"
replace occS ="Personal care and service workers, all other "== "4650"
replace occS ="Communications equipment operators, all other"== "5030"
replace occS ="Dispatchers"== "5520"
replace occS ="Stock clerks and order fillers"== "5620"
replace occS ="Secretaries and administrative assistants"== "5700"
replace occS ="Computer operators"== "5800"
replace occS ="Fishers and related fishing workers"== "6100"
replace occS ="Hunters and trappers"== "6110"
replace occS ="Paving, surfacing, and tamping equipment operators"== "6300"
replace occS ="Pile-driver operators"== "6310"
replace occS ="Operating engineers and other construction equipment operators"== "6320"
replace occS ="Painters, construction and maintenance"== "6420"
replace occS ="Paperhangers"== "6430"
replace occS ="Pipelayers, plumbers, pipefitters, and steamfitters"== "6440"
replace occS ="Earth drillers, except oil and gas"== "6820"
replace occS ="Explosives workers, ordnance handling experts, and blasters"== "6830"
replace occS ="Mining machine operators"== "6840"
replace occS ="Roof bolters, mining"== "6910"
replace occS ="Helpers--extraction workers"== "6930"
replace occS ="Other extraction workers"== "6940"
replace occS ="Signal and track switch repairers"== "7600"
replace occS ="Other installation, maintenance, and repair workers"== "7630"
replace occS ="Computer control programmers and operators"== "7900"
replace occS ="Extruding and drawing machine setters, operators, and tenders, metal and plastic"== "7920"
replace occS ="Forging machine setters, operators, and tenders, metal and plastic"== "7930"
replace occS ="Rolling machine setters, operators, and tenders, metal and plastic"== "7940"
replace occS ="Drilling and boring machine tool setters, operators, and tenders, metal and plastic "== "7960"
replace occS ="Lathe and turning machine tool setters, operators, and tenders, metal and plastic"== "8010"
replace occS ="Milling and planing machine setters, operators, and tenders, metal and plastic"== "8020"
replace occS ="Multiple machine tool setters, operators, and tenders, metal and plastic "== "8120"
replace occS ="Heat treating equipment setters, operators, and tenders, metal and plastic"== "8150"
replace occS ="Layout workers, metal and plastic"== "8160"
replace occS ="Plating and coating machine setters, operators, and tenders, metal and plastic"== "8200"
replace occS ="Tool grinders, filers, and sharpeners"== "8210"
replace occS ="Metal workers and plastic workers, all other"== "8220"
replace occS ="Shoe and leather workers and repairers"== "8330"
replace occS ="Shoe machine operators and tenders"== "8340"
replace occS ="Textile bleaching and dyeing machine operators and tenders"== "8360"
replace occS ="Textile cutting machine setters, operators, and tenders"== "8400"
replace occS ="Textile knitting and weaving machine setters, operators, and tenders"== "8410"
replace occS ="Textile winding, twisting, and drawing out machine setters, operators, and tenders"== "8420"
replace occS ="Extruding and forming machine setters, operators, and tenders, synthetic and glass fibers"== "8430"
replace occS ="Fabric and apparel patternmakers"== "8440"
replace occS ="Textile, apparel, and furnishings workers, all other"== "8460"
replace occS ="Model makers and patternmakers, wood"== "8520"
replace occS ="Woodworkers, all other"== "8550"
replace occS ="Semiconductor processors"== "8840"
replace occS ="Cleaning, washing, and metal pickling equipment operators and tenders"== "8860"
replace occS ="Cooling and freezing equipment operators and tenders"== "8900"
replace occS ="Production workers, all other"== "8965"
replace occS ="Supervisors of transportation and material moving workers"== "9000"
replace occS ="Bus drivers"== "9120"
replace occS ="Taxi drivers and chauffeurs"== "9140"
replace occS ="Locomotive engineers and operators"== "9200"
replace occS ="Railroad brake, signal, and switch operators"== "9230"
replace occS ="Subway, streetcar, and other rail transportation workers"== "9260"
replace occS ="Bridge and lock tenders"== "9340"
replace occS ="Automotive and watercraft service attendants   "== "9360"
replace occS ="Other transportation workers "== "9420"
replace occS ="Conveyor operators and tenders"== "9500"
replace occS ="Dredge, excavating, and loading machine operators"== "9520"
replace occS ="Hoist and winch operators"== "9560"
replace occS ="Mine shuttle car operators"== "9730"
replace occS ="Tank car, truck, and ship loaders"== "9740"
replace occS ="Material moving workers, all other"== "9750"
replace occS ="Military enlisted tactical operations and air/weapons specialists and crew members"== "9820"
