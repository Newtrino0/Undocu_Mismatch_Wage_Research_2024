...
global covars_reghdfe hisp male gov_worker bpl_foreign immig_by_ten nonfluent yrsed metropolitan
...
reghdfe vmismatched hundermatched hovermatched gbm_high_prob##ib5.degfield_broader $covars_reghdfe [pweight=perwt], absorb(statefip year age) vce(cluster statefip)
estadd ysumm
eststo gbmhigh_vmismatch

reghdfe vmismatched hundermatched hovermatched gbm_low_prob##ib5.degfield_broader $covars_reghdfe [pweight=perwt], absorb(statefip year age) vce(cluster statefip)
estadd ysumm
eststo gbmlow_vmismatch

esttab logical_vmismatch gbmhigh_vmismatch gbmlow_vmismatch using "/Output/Appendix/vmismatch_regressions_degree.tex", replace label booktabs drop($covars_reghdfe) ///
...
reghdfe hundermatched vmismatched gbm_high_prob##ib5.degfield_broader $covars_reghdfe [pweight=perwt], absorb(statefip##year age) vce(cluster statefip)
estadd ysumm
eststo gbmhigh_hunder

reghdfe hundermatched vmismatched gbm_low_prob##ib5.degfield_broader $covars_reghdfe [pweight=perwt], absorb(statefip##year age) vce(cluster statefip)
estadd ysumm
eststo gbmlow_hunder

esttab logical_hunder gbmhigh_hunder gbmlow_hunder using hunder_regressions_degree.tex, replace label booktabs drop($covars_reghdfe) ///
rename(1.degfield_broader "STEM" 2.degfield_broader "STEM Related" 3.degfield_broader "Business" 4.degfield_broader "Education" ///
1.gbm_low_prob "Undocu (low prob group)" 1.gbm_low_prob#2.degfield_broader "Low Prob x STEM Related" 1.gbm_low_prob#3.degfield_broader "Low Prob x Business" 1.gbm_low_prob#4.degfield_broader "Low Prob x Education" 1.gbm_low_prob#1.degfield_broader "Low Prob x STEM" ///
1.gbm_high_prob "Undocu (high prob group)" 1.gbm_high_prob#2.degfield_broader "High Prob x STEM Related" 1.gbm_high_prob#3.degfield_broader "High Prob x Business" 1.gbm_high_prob#4.degfield_broader "High Prob x Education" 1.gbm_high_prob#1.degfield_broader "High Prob x STEM" ///
1.undocu "Undocu (logical)" 1.undocu#2.degfield_broader "Undocu x STEM Related" 1.undocu#3.degfield_broader "Undocu x Business" 1.undocu#4.degfield_broader "Undocu x Education" 1.undocu#1.degfield_broader "Undocu x STEM") ///
...
reghdfe ln_adj vmismatched hundermatched hovermatched gbm_high_prob##ib5.degfield_broader $covars_reghdfe [pweight=perwt], absorb(statefip##year age) vce(cluster statefip)
estadd ysumm
eststo gbmhigh_wage

reghdfe ln_adj vmismatched hundermatched hovermatched gbm_low_prob##ib5.degfield_broader $covars_reghdfe [pweight=perwt], absorb(statefip##year age) vce(cluster statefip)
estadd ysumm
eststo gbmlow_wage

esttab logical_wage gbmhigh_wage gbmlow_wage using wage_regressions_degree.tex, replace label booktabs drop($covars_reghdfe) ///
rename(1.degfield_broader "STEM" 2.degfield_broader "STEM Related" 3.degfield_broader "Business" 4.degfield_broader "Education" ///
1.gbm_low_prob "Undocu (low prob group)" 1.gbm_low_prob#2.degfield_broader "Low Prob x STEM Related" 1.gbm_low_prob#3.degfield_broader "Low Prob x Business" 1.gbm_low_prob#4.degfield_broader "Low Prob x Education" 1.gbm_low_prob#1.degfield_broader "Low Prob x STEM" ///
1.gbm_high_prob "Undocu (high prob group)" 1.gbm_high_prob#2.degfield_broader "High Prob x STEM Related" 1.gbm_high_prob#3.degfield_broader "High Prob x Business" 1.gbm_high_prob#4.degfield_broader "High Prob x Education" 1.gbm_high_prob#1.degfield_broader "High Prob x STEM" ///
1.undocu "Undocu (logical)" 1.undocu#2.degfield_broader "Undocu x STEM Related" 1.undocu#3.degfield_broader "Undocu x Business" 1.undocu#4.degfield_broader "Undocu x Education" 1.undocu#1.degfield_broader "Undocu x STEM") ///
...
xline(0) graph export deg_coeff.png, replace
...
eststo logical_vmismatch
reghdfe vmismatched hundermatched hovermatched gbm_high_prob gbm_high_prob_inclusive $covars_reghdfe [pweight=perwt], absorb(statefip##year age degfield_broader) vce(cluster statefip)
eststo gbmhigh_vmismatch
reghdfe vmismatched hundermatched hovermatched gbm_low_prob gbm_low_prob_inclusive $covars_reghdfe [pweight=perwt], absorb(statefip##year age degfield_broader) vce(cluster statefip)
eststo gbmlow_vmismatch
...
eststo logical_hunder
reghdfe hundermatched vmismatched gbm_high_prob gbm_high_prob_inclusive $covars_reghdfe [pweight=perwt], absorb(statefip##year age degfield_broader) vce(cluster statefip)
eststo gbmhigh_hunder
reghdfe hundermatched vmismatched gbm_low_prob gbm_low_prob_inclusive $covars_reghdfe [pweight=perwt], absorb(statefip##year age degfield_broader) vce(cluster statefip)
eststo gbmlow_hunder

esttab logical_hunder gbmhigh_hunder gbmlow_hunder using hunder_regressions_ipc.tex, replace label booktabs drop($covars_reghdfe) ///
rename(undocu "Undocumented" gbm_high_prob "Undocu (high prob group)" gbm_low_prob "Undocu (low prob group)" ///
undocu_inclusive "Undocu x Inclusive" gbm_high_prob_inclusive "High Prob x Inclusive" gbm_low_prob_inclusive "Low Prob x Inclusive") ///
