...
graph export "/Output/Figures/degree_hunder.png", replace
...
graph export "/Output/Figures/degree_wage.png", replace
...
xline(0) ///
graph export "/Output/Figures/deg_coeff.png", replace
...
esttab logical_vmismatch gbmhigh_vmismatch gbmlow_vmismatch using "/Output/Appendix/vmismatch_regressions_ipc.tex", replace label booktabs drop($covars_reghdfe) ///
...
esttab logical_hunder gbmhigh_hunder gbmlow_hunder using "/Output/Appendix/hunder_regressions_ipc.tex", replace label booktabs drop($covars) ///
rename(undocu "Undocumented" gbm_high_prob "Undocu (high prob group)" gbm_low_prob "Undocu (low prob group)" ///
undocu_inclusive "Undocu x Inclusive" gbm_high_prob_inclusive "High Prob x Inclusive" gbm_low_prob_inclusive "Low Prob x Inclusive") ///
...
esttab logical_wage gbmhigh_wage gbmlow_wage using "/Output/Appendix/wage_regressions_ipc.tex", replace label booktabs drop($covars) ///
rename(undocu "Undocumented" gbm_high_prob "Undocu (high prob group)" gbm_low_prob "Undocu (low prob group)" ///
undocu_inclusive "Undocu x Inclusive" gbm_high_prob_inclusive "High Prob x Inclusive" gbm_low_prob_inclusive "Low Prob x Inclusive") ///
...
coefplot (logical_vmismatch, label(Logical)) (gbmhigh_vmismatch, label(GBM High)) (gbmlow_vmismatch, label(GBM Low)), ///
drop($covars hundermatched hovermatched) xline(0) title("Vertical Mismatch") ///
graph export "/Output/Figures/ipc_vmismatch.png", replace

coefplot (logical_hunder, label(Logical)) (gbmhigh_hunder, label(GBM High)) (gbmlow_hunder, label(GBM Low)), ///
drop($covars vmismatched) xline(0) title("Horizontal Undermatch") ///
graph export "/Output/Figures/ipc_hunder.png", replace

coefplot (logical_wage, label(Logical)) (gbmhigh_wage, label(GBM High)) (gbmlow_wage, label(GBM Low)), ///
drop($covars vmismatched hundermatched hovermatched) xline(0) title("Log Wage") ///
graph export "/Output/Figures/ipc_wage.png", replace
...
esttab logical_vmismatch gbmhigh_vmismatch gbmlow_vmismatch using "/Output/Appendix/vmismatch_regressions_policies.tex", replace label booktabs drop($covars) ///
rename(undocu "Undocumented" gbm_high_prob "Undocu (high prob group)" gbm_low_prob "Undocu (low prob group)" ///
...
esttab logical_hunder gbmhigh_hunder gbmlow_hunder using "/Output/Appendix/hunder_regressions_policies.tex", replace label booktabs drop($covars) ///
rename(undocu "Undocumented" gbm_high_prob "Undocu (high prob group)" gbm_low_prob "Undocu (low prob group)" ///
undocu_everify "Undocu x Inclusive Everify" gbm_high_prob_everify "High Prob x Inclusive Everify" gbm_low_prob_everify "Low Prob x Inclusive Everify" ///
undocu_license "Undocu x Inclusive OCC" gbm_high_prob_license "High Prob x Inclusive OCC" gbm_low_prob_license "Low Prob x Inclusive OCC" ///
undocu_drive "Undocu x Inclusive Drive" gbm_high_prob_drive "High Prob x Inclusive Drive" gbm_low_prob_drive "Low Prob x Inclusive Drive") ///
...
esttab logical_wage gbmhigh_wage gbmlow_wage using "/Output/Appendix/wage_regressions_policies.tex", replace label booktabs drop($covars) ///
rename(undocu "Undocumented" gbm_high_prob "Undocu (high prob group)" gbm_low_prob "Undocu (low prob group)" ///
undocu_everify "Undocu x Inclusive Everify" gbm_high_prob_everify "High Prob x Inclusive Everify" gbm_low_prob_everify "Low Prob x Inclusive Everify" ///
undocu_license "Undocu x Inclusive OCC" gbm_high_prob_license "High Prob x Inclusive OCC" gbm_low_prob_license "Low Prob x Inclusive OCC" ///
undocu_drive "Undocu x Inclusive Drive" gbm_high_prob_drive "High Prob x Inclusive Drive" gbm_low_prob_drive "Low Prob x Inclusive Drive") ///
